...
optimize/manage skill (`/adup-staging:optimize-budget`, `/adup-staging:google-optimize`,
`/adup-staging:manage-status`, `/adup-staging:create-ads`, etc.) — but only when they ask.
