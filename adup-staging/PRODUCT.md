...
|----------|-------|-------------|
| **Setup** | `/adup-staging:setup` | Configure API key |
| | `/adup-staging:connect` | Verify connection |
| | `/adup-staging:shop-select` | Switch client (agencies) |
| **Analysis** | `/adup-staging:ads-overview` | Quick cross-platform summary |
| | `/adup-staging:facebook-ads` | Deep Facebook/Instagram analysis |
| | `/adup-staging:google-ads` | Google Ads performance |
| | `/adup-staging:analytics` | GA4 web analytics |
| | `/adup-staging:cross-platform` | Unified dashboard |
| | `/adup-staging:budget-tracker` | Budget pacing alerts |
| | `/adup-staging:ad-fatigue` | Creative fatigue scoring |
| | `/adup-staging:creative-intelligence` | Creative playbook builder |
| **Actions** | `/adup-staging:optimize-budget` | Budget reallocation proposals |
| | `/adup-staging:manage-status` | Pause/activate proposals |
| | `/adup-staging:create-ads` | New ad creation proposals |
| | `/adup-staging:google-optimize` | Google Ads optimisation |
| | `/adup-staging:linkedin-optimize` | LinkedIn optimisation |
| | `/adup-staging:tiktok-optimize` | TikTok optimisation |
| **Reporting** | `/adup-staging:monday-briefing` | Weekly executive briefing |
| | `/adup-staging:client-report` | Client-ready reports |
| | `/adup-staging:anomaly-alerts` | Real-time anomaly detection |
