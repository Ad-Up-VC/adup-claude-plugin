...
- TikTok IS available via MCP under the `tiktok__` prefix — use `tiktok__get_tiktok_campaign_reports(shop_slug="<slug>", ...)` for campaign-level spend, clicks, CTR, and conversions
